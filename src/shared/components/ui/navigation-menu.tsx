...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
)
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon
        className="group-data-open/navigation-menu-trigger:text-primary relative top-px ml-1 size-3 transition duration-300 group-data-open/navigation-menu-trigger:rotate-180 group-data-popup-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  )
...
function NavigationMenuViewport({
  ...
  return (
    <div className={cn("absolute top-full left-0 isolate z-50 flex w-screen justify-center")}>
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          "origin-top-center bg-popover text-popover-foreground ring-foreground/10",
          ...
          "relative -mt-1.5 h-(--radix-navigation-menu-viewport-height) w-screen max-w-none overflow-hidden rounded-lg shadow ring-1",
