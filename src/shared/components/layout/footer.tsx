        ...
        <div className="mt-10 flex flex-col gap-4 max-sm:mt-5 max-sm:gap-1">
          ...
          <div className="flex flex-col gap-4">
            <p>
              ...
              Our mission is to leverage the individual knowledge and experience, as well as our
              teamwork and organizational learning, to derive optimal solutions to our clients' IT
              challenges.`}
            </p>
          </div>
          ...
          <div className="mt-2 flex flex-col gap-3">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>
                Head Office: 2F, Au Viet Building, No.1 Le Duc Tho Street, Tu Liem Ward, Ha Noi
              </span>
            </div>
            <div className="flex items-start gap-2">
              <MapPin size={16} className="mt-1 shrink-0 text-gray-500" />
              <span>
                Branch: 5F, Lighthouse Building, 1254 Xo Viet Nghe Tinh Street, Hoa Cuong Ward, Da
                Nang
              </span>
            </div>
          </div>
